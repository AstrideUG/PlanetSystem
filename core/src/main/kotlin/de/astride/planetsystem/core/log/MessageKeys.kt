...
enum class MessageKeys(value: String? = null) {
    ...
    COMMANDS_DELETE_FAILED_NOT_OWN_PLANET,
    COMMANDS_DELETE_OTHER_ADD_CONFIRMED,
    COMMANDS_DELETE_SUCCESSES,
    ...
    COMMANDS_REMOVE_SUCCESSES_TARGET,
    COMMANDS_REMOVE_SUCCESSES_PLAYER,
    COMMANDS_REMOVE_FAILED_IS_NOT_A_PLANET_MEMBER,
    COMMANDS_REMOVE_FAILED_ARGS_SIZE_IS_NOT_1,

    COMMANDS_KICK_TARGET_SUCCESSFULLY,
    COMMANDS_KICK_YOU_WAS_KICKED,
    COMMANDS_KICK_TARGET_FAILED,
    COMMANDS_KICK_TARGET_IS_NOT_ONLINE,
